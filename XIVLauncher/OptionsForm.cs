...
namespace XIVLauncher
{
    public partial class OptionsForm : Form
    {
        public OptionsForm()
        {
            ...
            ExpansionSelector.SelectedIndex = System.Convert.ToInt32(Properties.Settings.Default.expansionlevel);
        ...
        private void SaveButton_Click(object sender, EventArgs e)
        {
            ...
            Properties.Settings.Default["expansionlevel"] = ExpansionSelector.SelectedIndex;
